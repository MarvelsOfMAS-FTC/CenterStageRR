...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0310625609124489;
        public double lateralInPerTick = 0.0267287277603135;
        public double trackWidthTicks = 728.9607657468111;

        // feedforward parameters (in tick units)
        public double kS = 0.0;
        public double kV = 0.00465;
        public double kA = 0.00118;
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if ((t >= timeTrajectory.duration && error.position.norm() < 0.5
                    ...
                    || t + 0.25 >= timeTrajectory.duration) {
